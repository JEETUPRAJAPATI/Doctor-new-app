  ...
  return (
    ...
    >
      ...
      >
        <Image
          source={{
            uri: "https://placehold.co/100x100/98FB98/000000.png?text=S",
          }}
        ...
        <View style={styles.profileInfo}>
          ...
          <ThemedText
            style={[styles.viewProfile, { color: themeColors.textSecondary }]}
          >
            View Profile
          </ThemedText>
        </View>
